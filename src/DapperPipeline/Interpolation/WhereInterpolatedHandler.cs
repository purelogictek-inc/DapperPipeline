...
public ref struct WhereInterpolatedHandler
{
    ...
    [Obsolete(
        "A bare string cannot go in a WHERE interpolation hole. Every other type binds automatically, " +
        ...
        "almost every time).  x.SqlIdentifier() emits it as a column NAME (validated against " +
